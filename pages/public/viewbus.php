    ...
    <div class="container">
        ...
        <div class="search-box">
            <form method="GET" class="search-form">
                <input type="text" name="from" placeholder="From (e.g., Kathmandu)"
                    value="<?php echo htmlspecialchars($from); ?>">
                <input type="text" name="to" placeholder="To (e.g., Dhading)"
                    ...
                    <div class="bus-card">
                        ...
                        <div class="detail-box">
                            <div class="bus-details">
                                ...
                                <div class="detail-item">
                                    <i class="fas fa-clock"></i>
                                    <span><?php echo formatTime($busItem['arrival_time']); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="bus-details">
                                <div class="detail-item">
                                    ...
                                    <span><?php echo $busItem['total_seats']; ?> seats</span>
                                </div>
                        ...
                        <?php if (isLoggedIn()): ?>
                            <a href="<?php echo BASE_URL; ?>/pages/user/makereservation.php?bus_id=<?php echo $busItem['id']; ?>"
