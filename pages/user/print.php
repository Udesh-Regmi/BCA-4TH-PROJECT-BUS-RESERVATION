...
if (!$reservationId) {
    setAlert('Invalid reservation ID', 'danger');
...
// Verify ownership
if ($reservation['user_id'] != getUserId() && !isAdmin()) {
    setAlert('Unauthorized access', 'danger');
    redirect(BASE_URL . '/pages/user/reservations.php');
    exit();
}

$backgroundImage = HOME_BANNER_IMG_URL;
$logoPath = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlYdel5zbQymqAKo2kRrBe2BblB9scLr3Lkw&s";

$departureDate = date('d M, Y', strtotime($reservation['booking_date']));
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
                url('<?php echo $backgroundImage; ?>') no-repeat   fixed;
...
<body>
    <a class="backButton" href="<?php echo BASE_URL; ?>/pages/user/reservations.php">
        ...
        <div class="ticket-card">
                ...
                <div class="passenger-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">#<?php echo $reservation['id']; ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Full Name</div>
                            <div class="info-value"><?php echo htmlspecialchars($reservation['passenger_name']); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Contact</div>
                            <div class="info-value">+977 <?php echo htmlspecialchars($reservation['passenger_phone']); ?></div>
                        </div>
                        <div class="info-item">
                ...
                <div class="details-section">
                    ...
                    <div class="detail-box">
                        ...
                        <div class="detail-value" style="font-size: 14px;">
                            <?php echo htmlspecialchars($reservation['transaction_id'] ?? 'N/A'); ?>
                        </div>
                    </div>

                    <div class="detail-box">
                        <div class="detail-label">Payment Method</div>
                        <div class="detail-value"><?php echo ucfirst(htmlspecialchars($reservation['payment_method'])); ?></div>
                        <div style="font-size: 14px; color: #28a745; margin-top: 5px; font-weight: 600;">
                            <i class="fas fa-check-circle"></i> <?php echo ucfirst(htmlspecialchars($reservation['status'])); ?>
                        </div>
                    </div>

                    <div class="detail-box payment-box">
                        <div class="detail-label">Total Amount</div>
                        <div class="detail-value">Rs. <?php echo number_format($reservation['total_amount'], 2); ?></div>
                    </div>
                </div>

                <div class="seat-display">
                    <div class="info" style="font-size: 14px; color: #eed232ff; margin-top: 5px; font-weight: 600;">
                        <?php echo $reservation['payment_method'] === 'cash' && $reservation['status'] === 'confirmed' 
                            ? "Please pay at the counter before boarding" 
            ...
            <div class="ticket-footer">
                <div class="footer-note">
                    <i class="fas fa-shield-alt"></i> This is a computer-generated ticket. No signature required.
                </div>
